...
export const metadata: Metadata = {
  ...
  description:
    'Commercial truck and trailer wheel alignment in Springfield, MO. 1 to 3 axles, Hunter machine, 20+ years, 10,000+ alignments. Serving I-44. Call to schedule.',
  keywords:
  ...
  openGraph: {
    title: 'Commercial Truck Alignment Springfield MO | Turning Point Alignments',
    description:
      'Commercial truck and trailer wheel alignment in Springfield, MO. Heavy-duty rigs, 20+ years experience. Serving I-44.',
    type: 'website',
